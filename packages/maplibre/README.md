...
Partial lower-admin artifacts can be scoped with `parentId`. For example, the historical Turkey
ADM3 artifact covers Gaziantep ADM2 parents only; an uncovered parent falls back to ADM2 with
