...
| ADM3               | Mahalle/Köy when a boundary source exists                                 | `neighbourhood`, `village`, or `locality` | Mahalle/Köy                       | partial/blocker                     |
...
ADM level when a reviewed source supplies that distinction.
